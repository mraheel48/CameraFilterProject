...
public class CamerafileUtil {
    ...
    private static String mDefaultFolder = "PGU";
    ...
    public static String getPath(Context context) {
        ...
        if (storagePath == null) {
            storagePath = externalStorageDirectory.getAbsolutePath() + "/DCIM/PGU";
    ...
    public static void saveTextContent(String text, String filename) {
        Log.i(LOG_TAG, "Saving text :" + filename.toString());
        ...
        try {
            ...
            Log.e(LOG_TAG, "Error: " + e.getMessage().toString());
        }
    }

    public static String getTextContent(String filename) {
        Log.i(LOG_TAG, "Reading text : " + filename.toString());
